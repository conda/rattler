...
## [0.4.8](https://github.com/conda/rattler/compare/rattler_upload-v0.4.7...rattler_upload-v0.4.8) - 2026-01-15

### Other

- updated the following local packages: rattler_conda_types, rattler_s3, rattler_config, rattler_networking, rattler_package_streaming, rattler_solve
