...
mod test {
    ...
    fn test_patched_file_receives_modification_time() {
        ...
        assert_eq!(
            ...
            "patched file should have modification_time ({}), not source mtime ({})",
            modification_time, source_time
        );
    }
    ...
    fn test_unpatched_file_keeps_source_mtime() {
        ...
        assert_eq!(
            ...
            "unpatched file should keep source mtime ({}), not modification_time ({})",
            source_time, modification_time
        );
    }
