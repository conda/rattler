...
impl DecisionMap {
    pub(crate) fn new(solvable_count: u32) -> Self {
        Self {
            map: vec![DecisionAndLevel::undecided(); solvable_count as usize],
        }
    }
