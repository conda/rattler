...
mod consts {
    ...
    pub const CLAP_CONFIG_OPTIONS: &str = "Configuration Options";
    pub const CONFIG_DIR: &str = "config";
    pub const CONFIG_FILE: &str = "config.yaml";
    pub const DEFAULT_CHANNELS: &str = "default_channels";
    pub const CONDA_REPODATA_CACHE_DIR: &str = "conda_repodata_cache_dir";
}
...
impl DetachedEnvironments {
    ...
    pub fn path(&self) -> Option<PathBuf> {
        match self {
            DetachedEnvironments::Path(p) => Some(p.clone()),
...
impl Config {
    ...
    ) -> Result<(Config, Set<String>), ConfigError> {
    ...
    pub fn set(&mut self, key: &str, value: Option<String>) -> Result<(), ConfigError> {
    ...
    pub fn save(&self, to: &Path) -> Result<(), ConfigError> {
        ...
        // .map_err(|e| {
        //     tracing::error!("failed to create directories in '{}': {}", parent.display(), e);
        //     ConfigError::FailedToCreateConfigDirectory((parent.to_path_buf(), e))
        // })?;
    ...
    pub fn gateway(&self) -> GatewayBuilder {
        ...
        let cache_dir = get_cache_dir().unwrap_or_else(|| {
