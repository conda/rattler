...
The rattler project has strict rules for AI usage:
...
Please remember that rattler is maintained by humans.
...
rattler is written with plenty of AI assistance, and many maintainers embrace
...
because we want to keep the keep the code quality high w.r.t to speed, readability
